...
const Navbar = () => {
  ...
  <nav className="mb-10 flex items-center justify-between py-6">
    ...
    <div className="m-8 flex items-center justify-center gap-5 text-2xl">
      <a href="https://drive.google.com/file/d/13YzvO_zwHNa61TudkadZvQ99tJj6lCFy/view?usp=sharing" download="TanyaJain_resume.pdf" className="relative flex items-center"><FaDownload></FaDownload></a>
